...
module.exports = {
  ...
  entry: {
    ...
    index: [
      ...
      'script-loader!codemirrorFoldCode',
      'script-loader!codemirrorFoldGutter',
      'script-loader!ot',
      'flowchart.js',
  ...
  resolve: {
    ...
    alias: {
      ...
      codemirrorFoldCode: path.join(__dirname, 'node_modules/codemirror/addon/fold/foldcode.js'),
      codemirrorFoldGutter: path.join(__dirname, 'node_modules/codemirror/addon/fold/foldgutter.js'),
